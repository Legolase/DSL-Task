...
### Installation
```
git clone --recurse-submodules https://github.com/Legolase/DSL-Task
```
...
./build-tests.sh
```
> All test cases are contained in [./test/test.cpp](https://github.com/Legolase/DSL-Task/blob/master/test/test.cpp)
